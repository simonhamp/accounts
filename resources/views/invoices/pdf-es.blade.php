...
<head>
    ...
    <title>{{ $invoice->isCreditNote() ? 'Nota de Crédito' : ($invoice->is_simplified ? 'Factura Simplificada' : 'Factura') }} {{ $invoice->invoice_number }}</title>
    <style>
        body {
    ...
    <div class="header">
        <div class="header-grid">
            <div class="header-left">
                <h1>{{ $invoice->isCreditNote() ? 'NOTA DE CRÉDITO' : ($invoice->is_simplified ? 'FACTURA SIMPLIFICADA' : 'FACTURA') }}</h1>
    ...
    <div class="payment-info">
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{ $invoice->items->whereNotNull('stripe_transaction_id')->isNotEmpty() ? 'Stripe' : 'Transferencia Bancaria' }}</td>
            </tr>
        </table>
